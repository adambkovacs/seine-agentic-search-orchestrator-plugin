...
description: Shared domain knowledge base for all Seine agents, covering the domain registry, evidence vocabulary, and Backend 2 methods. Read by other agents before acting; not directly invoked.
---
